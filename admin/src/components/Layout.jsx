    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden' }}>
      <aside style={{
        ...
        <div style={{ padding: '24px 20px 20px', borderBottom: '1px solid var(--border2)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 10, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Admin</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '16px 20px', borderTop: '1px solid var(--border2)' }}>
          <div style={{ fontSize: 13, color: 'var(--muted)', marginBottom: 2 }}>{user?.name || 'Admin'}</div>
          <div style={{ fontSize: 11, color: 'var(--muted)', opacity: 0.6, marginBottom: 12 }}>{user?.email}</div>
